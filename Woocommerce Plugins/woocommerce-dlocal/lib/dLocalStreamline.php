 ...
 * require_once 'dLocalStreamline.class.php';
...
/**
 * Class of dLocal Streamline
 * @version 1.0
 *
 */

class dLocalStreamline {
	...
	public function __construct($sandbox){
		...
		$this->url['newinvoice'] = 'https://api.dlocal.com/api_curl/streamline/newinvoice/';
		$this->url['status'] = 'https://api.dlocal.com/apd/webpaystatus';
		$this->url['exchange'] = 'https://api.dlocal.com/apd/webcurrencyexchange';
		$this->url['banks'] = 'https://api.dlocal.com/api_curl/apd/get_banks_by_country';

		if ($this->sandbox){
			$this->url['newinvoice'] = 'https://sandbox.dlocal.com/api_curl/streamline/newinvoice';
			$this->url['status'] = 'https://sandbox.dlocal.com/apd/webpaystatus';
			$this->url['exchange'] = 'https://sandbox.dlocal.com/apd/webcurrencyexchange';
			$this->url['banks'] = 'https://sandbox.dlocal.com/api_curl/apd/get_banks_by_country';
		}
	}

	public function init_credencials($x_login, $x_trans_key, $x_login_for_webpaystatus, $x_trans_key_for_webpaystatus, $secret_key, $sandbox = true){
